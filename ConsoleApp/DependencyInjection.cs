...
namespace ConsoleApp.DI
{
    public static class DependencyInjection
    {
        public static WindsorContainer CreateContainer()
        {
            ...
            container.Register(Component.For<ICalculator>().ImplementedBy<Calculator>().Interceptors<LoggingInterceptor>());
        ...
        {
            return Classes.FromAssembly(typeof(Calculator).Assembly).BasedOn<ICalculator>();
        }
